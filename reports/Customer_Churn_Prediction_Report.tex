...
\caption{Confusion Matrices for Logistic Regression, Decision Tree and Random Forest (after tuning).}
...
\caption{Confusion Matrices for SVM, and Naive Bayes (after tuning).}
